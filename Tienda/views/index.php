        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="./" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Tienda</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    <a href="./" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Productos</a>
                    <a href="./" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Ajustes</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Administrador</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="insertar_productos.php" class="dropdown-item">Insertar Producto</a>
                            <a href="administrar_usuarios.php" class="dropdown-item">Panel de Usuarios</a>
                        </div>
                    </div>
                </div>
            </nav>
